...
import rw.ac.rca.bankManagement.v1.dto.requests.CreateUserDTO;
import rw.ac.rca.bankManagement.v1.dto.requests.UpdateRoleDTO;
import rw.ac.rca.bankManagement.v1.dto.responses.LoginResponse;
import rw.ac.rca.bankManagement.v1.dto.responses.UserDTOMapper;
import rw.ac.rca.bankManagement.v1.dto.requests.UserLoginDTO;
import rw.ac.rca.bankManagement.v1.exceptions.LoginFailedException;
import rw.ac.rca.bankManagement.v1.exceptions.ResourceNotFoundException;
import rw.ac.rca.bankManagement.v1.models.Role;
import rw.ac.rca.bankManagement.v1.models.User;
import rw.ac.rca.bankManagement.v1.payload.ApiResponse;
import rw.ac.rca.bankManagement.v1.repositories.RoleRepository;
import rw.ac.rca.bankManagement.v1.repositories.UserRepository;
import rw.ac.rca.bankManagement.v1.security.jwt.JwtUtils;
import rw.ac.rca.bankManagement.v1.security.user.UserAuthority;
import rw.ac.rca.bankManagement.v1.security.user.UserSecurityDetails;
import rw.ac.rca.bankManagement.v1.security.user.UserSecurityDetailsService;
import rw.ac.rca.bankManagement.v1.services.UserService;
import rw.ac.rca.bankManagement.v1.utils.Hash;
...
//             }
    ...
    public void updateUserMapper(Optional<User> user, CreateUserDTO createUserDTO){
        ...
        user.get().setGender(createUserDTO.getGender());
    }
