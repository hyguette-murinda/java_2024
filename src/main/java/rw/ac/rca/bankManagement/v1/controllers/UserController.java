...
import rw.ac.rca.bankManagement.v1.serviceImpls.UserServiceImpl;
...
public class UserController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ApiResponse> createUser(@RequestBody @Valid CreateUserDTO createUserDTO) throws Exception{
